...
startButton.addEventListener("click", () => {
    ...
    if (input== ""){
        ...
        questionLanding.innerHTML = "Please give me your name before you start cutie!"
    }
    else{
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Hello "+input+ "! Do you perhaps love me?</h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay!I knew you did. Lets have icecream together sometime...? ❤️, "+input+ "<333 </h2>"+
